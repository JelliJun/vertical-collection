...
export default class Radar {
  constructor(
    ...
    this._domPool = document.createElement('div');
  ...
  update() {
    ...
    this.schedule('measure', () => {
      ...
      // Check to see if we should rerender
      if (incrementalRender === true && this._shouldScheduleRerender()) {
        this.scheduleUpdate();
      }
  ...
  _updateVirtualComponents() {
    ...
    if (_componentPool.length > 0) {
      if (shouldRecycle) {
        ...
        for (let component of _componentPool) {
